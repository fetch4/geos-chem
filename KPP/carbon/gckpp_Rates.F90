...
! End INLINED RCONST
  ...
  RCONST(2) = (1.75d-10)
  RCONST(3) = (9.60d-12*EXP(-1360.0d0/TEMP))
  RCONST(4) = (k_soil(1))
  RCONST(5) = (2.45d-12*EXP(-1775.0d0/TEMP))
  RCONST(6) = (1.75d-10)
  RCONST(7) = (9.60d-12*EXP(-1360.0d0/TEMP))
  RCONST(8) = (k_soil(2))
  RCONST(9) = (2.45d-12*EXP(-1775.0d0/TEMP)/1.0061d0)
  RCONST(10) = (1.75d-10/1.013d0)
  RCONST(11) = (9.60d-12*EXP(-1360.0d0/TEMP)/1.0621d0)
  RCONST(12) = (k_soil(3))
  RCONST(13) = (2.45d-12*EXP(-1775.0d0/TEMP)/1.0078d0)
  RCONST(14) = (1.75d-10/1.026d0)
  RCONST(15) = (9.60d-12*EXP(-1360.0d0/TEMP)/1.136d0)
  RCONST(16) = (k_soil(4))
  RCONST(17) = (2.45d-12*EXP(-1775.0d0/TEMP))
  RCONST(18) = (1.75d-10)
  RCONST(19) = (9.60d-12*EXP(-1360.0d0/TEMP))
  RCONST(20) = (k_soil(5))
  RCONST(21) = (3.50d-12*EXP(-1950.0d0/TEMP))
  RCONST(22) = (1.75d-10/1.06d0)
  RCONST(23) = (9.60d-12*EXP(-1360.0d0/TEMP)/(1.278d0*EXP(51.31d0/TEMP)))
  RCONST(24) = (k_soil(6))
  RCONST(25) = (k_Trop(2))
  RCONST(26) = (k_Trop(3))
  RCONST(27) = (k_Strat(2))
