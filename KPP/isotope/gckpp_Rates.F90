...
! End inlined code from F90_RCONST
  ...
  RCONST(1) = (2.45d-12*EXP(-1775.0d0/TEMP))
  RCONST(2) = (9.60d-12*EXP(-1360.0d0/TEMP))
  RCONST(3) = (1.75d-10)
  RCONST(4) = (k_soil)
  RCONST(5) = (2.45d-12*EXP(-1775.0d0/TEMP))
  RCONST(6) = (9.60d-12*EXP(-1360.0d0/TEMP))
  RCONST(7) = (1.75d-10)
  RCONST(8) = (k_soil)
  RCONST(9) = (2.45d-12*EXP(-1775.0d0/TEMP)/1.0061d0)
  RCONST(10) = (9.60d-12*EXP(-1360.0d0/TEMP)/1.0621d0)
  RCONST(11) = (1.75d-10/1.0130d0)
  RCONST(12) = (k_soil/1.018d0)
  RCONST(13) = (3.50d-12*EXP(-1950.0d0/TEMP))
  RCONST(14) = (9.60d-12*EXP(-1360.0d0/TEMP)/(1.278d0*EXP(51.31/TEMP)))
  RCONST(15) = (1.75d-10/1.0600d0)
  RCONST(16) = (k_soil/1.083d0)
  RCONST(17) = (2.45d-12*EXP(-1775.0d0/TEMP)/1.34d0)
  RCONST(18) = (9.60d-12*EXP(-1360.0d0/TEMP)/1.60d0)
  RCONST(19) = (1.75d-10/1.0600d0/1.0130d0)
  RCONST(20) = (k_soil/1.018d0/1.083d0)
  RCONST(21) = (2.45d-12*EXP(-1775.0d0/TEMP)/1.0078d0)
  RCONST(22) = (9.60d-12*EXP(-1360.0d0/TEMP)/1.136d0)
  RCONST(23) = (1.75d-10/1.026d0)
  RCONST(24) = (k_soil/1.036d0)
  RCONST(25) = (3.833082d-12)
  RCONST(26) = (GCJPLPR_abab(6.9d-33,2.1d0,1.1d-12,-1.3d0,0.6d0)+GCJPLAC_ababac(6.9d-33,2.1d0,1.1d-12,-1.3d0,1.85d-13,&
                 &-6.5d1,0.6d0))
  RCONST(27) = (3.833082d-12)
