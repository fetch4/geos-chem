...
## User-modifiable configuration files
  ...
  1. **fetch4.kpp**: Master KPP specification file (which is a copy of
     ../fullchem/fullchem.kpp).  The **gckpp.kpp* file symbolically
     links to this file.

  2. **fetch4.eqn**: KPP equation file (which is a copy of
...
a copy of these files.  You can rename these to fetch4_*.F90, etc.
